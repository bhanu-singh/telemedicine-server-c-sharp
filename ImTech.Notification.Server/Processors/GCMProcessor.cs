...
{
    public class GCMProcessor : MessageProcessor
    {
        public static GCMProcessor Instance = new GCMProcessor();
        ...
        public override void Process(object message)
        {
            ...
            LogManager.Instance.Log("GCM sent to " + ((BaseMessage)message).UserDeviceToken);
        }
