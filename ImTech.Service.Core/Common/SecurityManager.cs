...
namespace ImTech.Service.Common
{
    public static class SecurityManager
    {
        ...
        {
            encriptionKey = ConfigurationManager.EncryptionKey;

        }
        private static byte[] EncryptionByteKey { get { return System.Text.Encoding.UTF8.GetBytes(encriptionKey); } }
        ...
        public static string EncryptText(string plainText)
        {
            ...
            byte[] passwordBytes = Encoding.UTF8.GetBytes(encriptionKey);
